	...
	a.makeSound = function(){
        ...
        whileplaying: function() {
          ...
          if (this.duration) { 
            ...
            a.dom.progress.css("width", width);

            // a.dom.time.html(a.getTime(this.position, true)+"/"+a.getTime(this.durationEstimate,true));
            // 更改为 显示剩余时间
            a.dom.time.html(a.getTime((this.durationEstimate - this.position), true));
        ...
        onfinish: function() {
          if (a.fCallBack != null) a.fCallBack()
        }
